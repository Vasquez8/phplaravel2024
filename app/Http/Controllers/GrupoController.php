...
class GrupoController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('grupos.index')->with('success', 'Grupo actualizado correctaente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('grupos.index')->with('success', 'Grupo eliminado correctaente');
    }
