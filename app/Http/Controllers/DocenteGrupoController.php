...
class DocenteGrupoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $docenteGrupos = $query->with('docente', 'grupo')
            ->orderBy('id', 'desc')
            ->simplePaginate(10);
        $docenteGrupos = $query->orderBy('id','desc')->simplePaginate(10);

        $docentes = Docente::all();
        return view('docentes_grupos.index', compact('docenteGrupos', 'docentes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('docentes_grupos.index')->with('success', 'Docente grupo actualizado correctaente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('docentes_grupos.index')->with('success', 'Docente grupo eliminado correctaente');
    }
}
