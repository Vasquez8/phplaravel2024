...
class EstudianteGrupoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $estudianteGrupos = $query->with('estudiante', 'grupo')
            ->orderBy('id', 'desc')
            ->simplePaginate(10);
        $estudianteGrupos = $query->orderBy('id','desc')->simplePaginate(10);

        $estudiantes = Estudiante::all();
        return view('estudiantes_grupos.index', compact('estudianteGrupos', 'estudiantes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('estudiantes_grupos.index')->with('success', 'Estudiante grupo actualizado correctaente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('estudiantes_grupos.index')->with('success', 'Estudiante grupo eliminado correctaente');
    }
}
