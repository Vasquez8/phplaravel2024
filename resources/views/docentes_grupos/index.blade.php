        ...
        <tbody>
            @foreach ($docenteGrupos as $docenteGrupo)
                <tr>
                    ...
                    <td>
                    <div class="d-flex">
                        <a href="{{ route('docentes_grupos.edit', $docenteGrupo->id) }}" class="btn btn-warning me-1">Editar</a>
                        <a href="{{ route('docentes_grupos.show', $docenteGrupo->id) }}" class="btn btn-info me-1">Ver</a>
